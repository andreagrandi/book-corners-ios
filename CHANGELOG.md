...
- Let staff review, approve, and reject submitted library photos from the Admin
  Dashboard
- Let staff filter, resolve, and dismiss user reports from the Admin Dashboard
...
- Secure token storage with automatic refresh on expiry
- Splash screen with async session restore
...
- Location permission prompt with call-to-action banner
